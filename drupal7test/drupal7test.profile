 ...
 */
function drupal7test_form_install_configure_form_alter(&$form, $form_state) {
 ...
 */
function drupal7test_install_tasks() {
  $tasks = array();

  $tasks['drupal7test_set_variables'] = array(
    'display_name' => st('Set Variables'),
    'display' => FALSE,
  );

  $tasks['drupal7test_setup_languages'] = array(
 ...
 */
function drupal7test_set_variables() {
  $variables = array(
    // Mime-mail.
 ...
 */
function drupal7test_setup_languages() {
